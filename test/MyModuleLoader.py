...
class ModuleLoader(object):
    def __init__(self, modulePath, object):
        self.moduleList = []
        self.modulePath = abs_path + modulePath  # 'exploit/web'
        self.object = object
...
if __name__ == '__main__':
    moduleloader = ModuleLoader('exploit\\web\\report', 'Script')
    moduleloader.defaultModuleLoad('script')
